...
public class FeathersAttributes {
    ...
    public static final RegistryObject<Attribute> MAX_FEATHERS = registerAttribute("greenfeathers.max_feathers",
            (id) -> new RangedAttribute(id, 20.0D, 0.0D, 40.0D).setSyncable(true),
            "d74ded8f-c5b6-4222-80e2-dbea7ccf8d02"
    );

    public static final RegistryObject<Attribute> MAX_STRAIN = registerAttribute("greenfeathers.max_strain",
            (id) -> new RangedAttribute(id, 6.0D, 0.0D, 40.0D).setSyncable(true),
            "d74ded8f-c5b6-4222-80e2-dbea7ccf8d02"
    );

    public static final RegistryObject<Attribute> FEATHERS_PER_SECOND = registerAttribute("greenfeathers.feathers_per_second",
            (id) -> new RangedAttribute(id, 0.4D, -40.0, 40.0D).setSyncable(true),
            "f39cfede-259c-45dd-b3fd-7307a8cc1255"
    );

    public static final RegistryObject<Attribute> STAMINA_USAGE_MULTIPLIER = registerAttribute("greenfeathers.usage_multiplier",
